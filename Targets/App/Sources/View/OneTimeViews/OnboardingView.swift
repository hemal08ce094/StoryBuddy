...
private let onboardingPages: [AnyView] = [
    AnyView(
        HeroView(
            ...
            title: "Welcome to Magic AI Story Maker!",
            subtitle: "Delight your child with AI-generated bedtime stories, crafted just for them.",
            bounceOnAppear: true
        )),
    AnyView(
        HeroView(
            sfSymbolName: "person.crop.circle.badge.plus",
            title: "Personalize Every Story",
            subtitle: "Add your child's name, pick a story type, and choose how long the story should be!"
        )),
    AnyView(
        HeroView(
            sfSymbolName: "clock.arrow.circlepath",
            title: "Visit Story History",
            subtitle: "Revisit and replay your favorite stories any time in the history section."
        )),
]
	...
	struct OnboardingView: View {
		...
		var body: some View {
			VStack {
				...
				Button(pageIndex == onboardingPages.count - 1 ? "All Set..!!" : "Next") {
					withAnimation {
