...
struct ShowFeatureSheetOnNewAppVersionModifier: ViewModifier {
	...
	struct WhatsNewView: View {
		...
		private let features: [Feature] = [
			Feature(
				sfSymbol: "book.closed", symbolColor: .blue, title: "Welcome to Magic AI Story Maker!",
				description: "Delight your child with AI-generated bedtime stories, crafted just for them."
			),
			Feature(
				sfSymbol: "person.crop.circle.badge.plus", symbolColor: .green, title: "Personalize Every Story",
				description: "Add your child's name, pick a story type, and choose how long the story should be!"
			),
			Feature(
				sfSymbol: "clock.arrow.circlepath", symbolColor: .orange, title: "Visit Story History",
				description: "Revisit and replay your favorite stories any time in the history section."
			)
		]
